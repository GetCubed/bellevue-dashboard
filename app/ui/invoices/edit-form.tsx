...
export default function EditInvoiceForm ({
  ...
  customers: CustomerField[];
	...
	const updateInvoiceWithId = (state: State, payload: FormData) => updateInvoice(invoice.id, state, payload);
            ...
            Choose customer
					...
					<div className="relative">
						<select
							id="customer"
							name="customerId"
							className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-text"
                ...
                Select a customer
						...
						<UserCircleIcon className="pointer-events-none absolute left-3 top-1/2 size-[18px] -translate-y-1/2 text-text" />
					</div>
				</div>
					...
					<div className="relative mt-2 rounded-md">
						<div className="relative">
							<input
								...
								className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-text"/>
							<CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 size-[18px] -translate-y-1/2 text-text peer-focus:text-gray-900" />
						</div>
					</div>
				</div>
